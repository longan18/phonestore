<div class="mb-3">
    <form action="#" id="fillter-product" method="GET">
        <div class="row">
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-4">
                ...
                <div class="d-flex">
                    <input class="form-control w-100 mr-1 filter-product" placeholder="Khoảng giá bắt đầu" data-name="price" name="start_price"/> <b>~</b>
                    <input class="form-control w-100 ml-1 filter-product" placeholder="Khoảng giá kết thúc" data-name="price" name="end_price"/>
                </div>
            </div>
            <div class="col-4">
                <label class="m-0 mr-2"><b>{{ __('Ngày:') }}</b></label>
                <div class="d-flex">
                    <input class="form-control w-100 search-status datepicker mr-1 filter-product" placeholder="Khoảng thời gian bắt đầu" name="start_date"/> <b>~</b>
                    <input class="form-control w-100 search-status datepicker ml-1 filter-product" placeholder="Khoảng thời gian kết thúc" name="end_date"/>
                </div>
            </div>
            <div class="col-4">
