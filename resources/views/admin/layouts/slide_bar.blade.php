<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item @if(currentRoute('customer') || currentRoute('address')) active @endif" href="{{ route('customer.index') }}"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Quản lý người dùng</span></a></li>
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Quản lý đơn hàng</span></a></li>
