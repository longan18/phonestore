<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview @if(currentRoute('smartphone')) is-expanded @endif">
            <a class="app-menu__item @if(currentRoute('smartphone')) active @endif" href="#" data-toggle="treeview">
